...
// New creates an instance of ddfbeat.
...
// Run starts ddfbeat.
func (bt *DDFbeat) Run(b *beat.Beat) error {
	logp.Info("ddfbeat is running! Hit CTRL-C to stop it.")
